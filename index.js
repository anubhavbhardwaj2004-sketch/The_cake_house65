//OPen stock 
if (document.getElementById('open-stock')) {
...
if (document.querySelector('.order-form')) {
    ...
    <ul style=\"padding-left:18px; margin:0 0 10px 0;\">
        ...
        <li>UPI Payment:<br>
            <a href='upi://pay?pa=9310249651@ibl&pn=Cake%20House&am=${finalTotal.toFixed(2)}&cu=INR' style='color:#25D366; font-weight:bold;' target='_blank'>
...
//open galary
if (document.getElementById('open-gallery')) {
...
//close galary
if (document.getElementById('close-gallery')) {
